    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        <div className="text-center mb-20">
          ...
          <motion.p className="text-xs tracking-[0.45em] uppercase mb-6" style={{ color: theme.color.skyBlue, fontFamily: theme.font.body }}
            initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.2, duration: 0.7 }}>
            {t.timelineEyebrow}
          </motion.p>

          <motion.h3 className="font-normal mb-4"
            style={{ fontFamily: theme.font.display, fontSize: "clamp(1.8rem, 5vw, 3rem)", color: theme.color.skyBlueLight }}
                ...
                >
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 z-10 flex flex-col items-center">
                    <motion.div
                      ...
                      style={{
                        background: `linear-gradient(135deg, ${theme.color.skyBlueDark}, ${theme.color.skyBlue})`,
                        boxShadow: `0 0 20px rgba(56,189,248,0.4), 0 0 0 4px rgba(56,189,248,0.1)`,
                        color: "#040D1E",
                        fontFamily: theme.font.display,
                      }}
                      animate={{ boxShadow: ["0 0 15px rgba(56,189,248,0.3)", "0 0 30px rgba(56,189,248,0.6)", "0 0 15px rgba(56,189,248,0.3)"] }}
  ...
  return (
    <div className="py-8 px-1" style={{ textAlign: align === "end" ? "right" : "left" }}>
      <p className="text-xs tracking-[0.3em] uppercase mb-2"
        style={{ color: theme.color.skyBlue, fontFamily: theme.font.body, opacity: 0.75 }}>
        {event.date}
      </p>
      <h4 className="font-normal mb-2"
        style={{ fontFamily: theme.font.display, fontSize: "clamp(1.1rem, 2.5vw, 1.5rem)", color: theme.color.skyBlueLight }}>
        {event.title}
      </h4>
